...
export default async function MultiPostDemoPage() {
      ...
      <div className="p-8 space-y-4">
        ...
        <div className="flex items-start gap-4 p-5 bg-amber-50 border border-amber-200 rounded-2xl max-w-xl">
          ...
          <div>
            ...
            <p className="text-amber-700 text-sm">คุณไม่สามารถสร้างโพสต์ได้ กรุณาติดต่อ Workspace Admin เพื่อขอสิทธิ์เพิ่มเติม</p>
          </div>
        </div>
      </div>
    );
  ...
  return <PublisherShell connections={connections} />;
}
